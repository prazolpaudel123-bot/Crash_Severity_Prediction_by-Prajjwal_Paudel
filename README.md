...
To run streamlit, go to terminal of the .py file and enter     py -m streamlit run "file_location\model_deploy1.py"
For example, in my device I enter:                             py -m streamlit run "L:\Softwares\VS Code\Files\model_deploy1.py"
A localhost appears in your default web browser and finally you are about to predict the severity of crash on the basis of your input.
